<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs" Inherits="SkillSwapAcademy.AdminRegister" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin Register - SkillSwap Academy</title>
        ...
        <div class="illustration-page">
            ...
            <div class="illustration-content">
                ...
                <div class="illustration-card">
                    <div class="auth-title-icon" style="background: linear-gradient(135deg, #6D28D9, #3D2E7C);"><i class="fas fa-user-shield"></i></div>
                    ...
                    <p class="auth-switch-link">Already have an account? <a href="AdminLogin.aspx">Login here</a></p>
                </div>
            </div>
        </div>
